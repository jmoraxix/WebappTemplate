...
ALTER TABLE SGCOM.ARTICULO ADD CONSTRAINT FK_ARTICULO_SUBCATEGORIA FOREIGN KEY (SUBCATEGORIA_ID) REFERENCES SGCOM.SUBCATEGORIA (SUBCATEGORIA_ID);
ALTER TABLE SGCOM.ARTICULO ADD CONSTRAINT FK_ARTICULO_MEDIDA FOREIGN KEY (MEDIDA_ID) REFERENCES SGCOM.MEDIDA (MEDIDA_ID);    

grant select, update, delete on SGCOM.CATEGORIA to SGCOMWEB;